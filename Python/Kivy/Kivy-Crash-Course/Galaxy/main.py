...
class MainWidget(RelativeLayout):
  ...
  def __init__(self, **kwargs):
    ...
    if self.is_desktop():
      self.__keyboard = Window.request_keyboard(self.keyboard_closed, self)
      self.__keyboard.bind(on_key_down=self.on_keyboard_down)
      self.__keyboard.bind(on_key_up=self.on_keyboard_up)
